...
public class StoreView {
    ...
    private final store.StoreManager sm;
    ...
    private JPanel makeButtonPanel() {
        ...
        viewCartButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                for (store.ProductStockPair item : sm.getCartContents(cartID)) {
...
//        }
    ...
    private JPanel makeBrowsePanel() {
        ...
        for (store.ProductStockPair item : sm.getAvailableProducts()) {
    ...
    private void addProductFrame(store.Product p, Container pane) {
        ...
        ImageIcon AppleImage = new ImageIcon(new ImageIcon(this.getClass().getResource("mixfruit.jpg")).getImage().getScaledInstance(200, 200, Image.SCALE_DEFAULT));
        JLabel img = new JLabel(AppleImage);

//        ImageIcon AvocadoImage = new ImageIcon(new ImageIcon(this.getClass().getResource("avocados.jpg")).getImage().getScaledInstance(200, 200, Image.SCALE_DEFAULT));
//        JLabel img2 = new JLabel(AvocadoImage);
//
//        ImageIcon BananaImage = new ImageIcon(new ImageIcon(this.getClass().getResource("bananas.jpg")).getImage().getScaledInstance(200, 200, Image.SCALE_DEFAULT));
//        JLabel img3 = new JLabel(BananaImage);
...
//        panel.add(img2, BorderLayout.CENTER);
//        panel.add(img3, BorderLayout.CENTER);
